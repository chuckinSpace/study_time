...
class _SettingsFormState extends State<SettingsForm> {
  ...
  DateTime _currentDueDate = DateTime.now();
        ...
        child: Column(
          children: <Widget>[
              ...
              children: <Widget>[
                new Flexible(
                  child: TextFormField(
                    ...
                    decoration:
                        textInputDecoration.copyWith(hintText: "Course Code"),
                    validator: (val) =>
            ...
            Visibility(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(_parsedDueDate == "" ? " Pick a Date" : _parsedDueDate),
                ],
              ),
            ),
            SizedBox(height: 20),
            ...
            RaisedButton(
                ...
                child: Text(widget.test != null ? "Update Test" : "Add Test",
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate() &&
                    ...
                    if (widget.test == null) {
                      ...
                      await DatabaseService(user.uid).createNewTest(
                          _currentSubject ?? "",
                      ...
                      if (isLoading == false) {
                        ...
                        await DatabaseService(user.uid)
                            .updateDocument("tests", widget.test.testId, {
